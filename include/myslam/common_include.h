...
// Include Headers that commonly used

#ifndef MYSLAM_COMMON_INCLUDE_H
#define MYSLAM_COMMON_INCLUDE_H

// std
#include <atomic> // library for atomic operation allowing for lockless concurrent programming
#include <condition_variable> // library for synchronization primitive
#include <mutex> // library for mutal exclusion facility
#include <typeinfo> // For dynamic tyoe and runtime type information
